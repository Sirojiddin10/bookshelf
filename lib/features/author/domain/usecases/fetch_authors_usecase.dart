...
class FetchAuthorsUseCase implements UseCase<({double resultCount, List<AuthorEntity> results}), String> {
  final AuthorRepository repository;

  FetchAuthorsUseCase(this.repository);

  @override
  Future<Either<Failure, ({double resultCount, List<AuthorEntity> results})>> call(String params) async {
    return await repository.fetchAuthors(params);
  }
}
